---
title: Version 1.1.x Update Notes
parent: Update Notes
nav_order: 1
---

# Version 1.1.x Update Notes

Update notes for every 1.1 patch release, newest first.
...
> v1.1.1 (above), which overrides the rank count for that application only.
> On v1.1 itself, use `--ranks 1`.
